...
void drawLineWeight(M5GFX *disp, int32_t x0, int32_t y0, int32_t x1, int32_t y1, uint8_t weight_px, uint8_t color565){
  uint8_t img[1] = {color565};
...
void setup() {
  ...
  drawLineWeight(&display, 0,0, 200,200, 10, 0xFF);
}
